...
| [FerriteCore](https://www.curseforge.com/minecraft/mc-mods/ferritecore-fabric) | **Has 1.17 Beta.** FerriteCore further reduces memory usage and should be used in conjunction with Hydrogen. | [malte0811](https://github.com/malte0811) |
...
| [Controlling](https://www.curseforge.com/minecraft/mc-mods/controlling-for-fabric) | **Has 1.17 Beta.** Controlling completely revamps Minecraft's controls menu, making it much easier to navigate and change keys. | [Jaredllll08](https://github.com/jaredlll08) |
...
| [Colored Lights](https://modrinth.com/mod/colored-lights) | **Crashes with Sodium** Colored Lights adds colored lighting to Minecraft with its colors completely customizable via resource pack. | [Gegy](https://github.com/Gegy) |
...
| [Varied Mob Textures](https://www.curseforge.com/minecraft/mc-mods/varied-mob-textures) | **No 1.17 Yet.** Varied mob textures. Does not support OptiFine format. | [Digifox03](https://github.com/Digifox03/variedMobs) |
