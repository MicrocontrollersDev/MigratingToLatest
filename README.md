...
| FastMathFabric | FastMathFabric is a joke mod meant to port the cursedness of OptiFine's fast math feature to fabric. It is incompatible with other mods and will not provide a performance gain, therefore leaving no reason for users to use it. | [FwuffyPetsOwO](https://github.com/FwuffyPetsOwO) |
